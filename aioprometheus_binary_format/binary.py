'''
This module implements a plugin to provide aioprometheus with a formatter
that emits metrics in a binary (Google Protocol Buffers) format.
'''

import pyrobuf_util
import prometheus_metrics_proto as pmp  # type: ignore

from aioprometheus.formats.base import IFormatter
from aioprometheus.collectors import Counter, Gauge, Summary, Histogram
